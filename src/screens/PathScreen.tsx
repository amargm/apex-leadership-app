...
export default function PathScreen(_: PathScreenProps) {
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        <Text style={styles.title}>YOUR TRACK</Text>
      ...
      <ScrollView
        ...
        showsVerticalScrollIndicator={false}
      >
        {/* Vertical progress line + nodes — wired in Phase 2 */}
        <View style={styles.placeholder}>
          <Text style={styles.placeholderTitle}>LEARNING PATH</Text>
          <Text style={styles.placeholderSub}>
            Track nodes wired in Phase 2
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
